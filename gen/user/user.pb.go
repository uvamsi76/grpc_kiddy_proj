...
const file_user_user_proto_rawDesc = "" +
	"\n" +
	"\x0fuser/user.proto\x12\x04user\"\xa2\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x10USER_ROLE_VIEWER\x10\x032\xc6\x02\n" +
	"\vUserService\x12?\n" +
	"\n" +
	...
	"\tListUsers\x12\x16.user.ListUsersRequest\x1a\x17.user.ListUsersResponseB.Z,github.com/uvamsi76/grpc_kiddy_proj/gen/userb\x06proto3"
...
var file_user_user_proto_depIdxs = []int32{
	...
	10, // 10: user.UserService.ListUsers:input_type -> user.ListUsersRequest
	...
	11, // 15: user.UserService.ListUsers:output_type -> user.ListUsersResponse
